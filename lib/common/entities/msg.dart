...
class Msg {
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      if (from_online != null) "to_avatar": from_online,
      if (to_online != null) "to_avatar": to_online,
      if (from_msg_num != null) "to_avatar": from_msg_num,
      if (to_msg_num != null) "to_avatar": to_msg_num,
